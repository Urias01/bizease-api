...
@Service
public class GetExpiredProductsUseCase {
    ...
    public PageReturn<List<Map<String, Object>>> execute(ProductExpiredFilter filter) {
        ...
        Page<Map<String, Object>> model = productsRepository.findExpiredProducts(commerceExists.get().getId(),
                pageRequest);
